    ...
    class Xcode
      class PodsProjectGenerator
        ...
        class PodTargetInstaller < TargetInstaller
          ...
          @cbin_warning_messages = {}

          class << self
            attr_reader :cbin_warning_messages
          end
          ...
          def add_swift_library_compatibility_header_phase(native_target)
            warn_once('========= swift add_swift_library_compatibility_header_phase')
            if $ARGV[1] == "auto"
              warn_once('========= auto swift add_swift_library_compatibility_header_phase')
              ...
              warn_once('========= null swift add_swift_library_compatibility_header_phase')
          ...
          def warn_once(message)
            return if self.class.cbin_warning_messages[message]

            self.class.cbin_warning_messages[message] = true
            UI.warn(message)
          end
